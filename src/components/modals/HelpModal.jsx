...
const HelpModal = ({ onClose }) => {
    ...
    return (
        ...
        >
            <div 
                className="w-full sm:max-w-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-t-3xl sm:rounded-3xl shadow-2xl p-6 relative flex flex-col max-h-[85vh] text-zinc-900 dark:text-zinc-100 animate-in slide-in-from-bottom-4 sm:zoom-in-95 duration-200"
            ...
            >
                ...
                <div className="flex items-center justify-between pb-4 border-b border-zinc-200 dark:border-zinc-800 mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 id="help-modal-title" className="text-lg sm:text-xl font-extrabold font-heading tracking-tight text-zinc-900 dark:text-white uppercase">
                                Guía Rápida — Colores Dayam
                            </h2>
                            <p className="text-xs text-zinc-500 dark:text-zinc-400 font-medium">Aprende a usar el estudio de color en 4 sencillos pasos</p>
                        </div>
                    </div>
                    <button 
                        type="button"
